...
public extension UIScrollView {
    ...
    func willBeScrolledToTop(withVerticalContentOffset verticalContentOffset: CGFloat) -> Bool {
        return self._willBeScrolledToTop(withVerticalContentOffset: verticalContentOffset)
    }
    
    func willBeScrolledToBottom(withVerticalContentOffset verticalContentOffset: CGFloat) -> Bool {
